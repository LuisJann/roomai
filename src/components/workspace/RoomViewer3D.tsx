...
import * as THREE from "three"; // <-- IMPORT SPOSTATO IN CIMA
    ...
    <div className="relative w-full aspect-[4/3] bg-gray-950 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800 shadow-md">
      ...
      <div className="absolute bottom-4 left-4 right-4 bg-black/85 backdrop-blur border border-white/10 rounded-xl p-3 flex flex-wrap justify-between items-center gap-3 text-xs text-white">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 text-[10px] font-semibold tracking-wider">
          <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-green-500 block" /><span>MANTIENI</span></div>
          <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-amber-500 block" /><span>VALUTA</span></div>
          <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-red-500 block" /><span>DA SOSTITUIRE</span></div>
          <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-blue-500 block animate-pulse" /><span>AI PROPOSTO</span></div>
        </div>
      </div>
